...
class ProgressMonitor:
    ...
    def _log_current_progress(self, progress_percent, verfilmt, eta, duration_str, rate):
        ...
        if eta and duration_str:
            ...
            self.logger.info(f"Progress: {progress_percent:.2f}% ({verfilmt}/{self.total_docs})")
    ...
    def _handle_completion(self, verfilmt):
        ...
        self.logger.info(f"Process completed: {verfilmt}/{self.total_docs} frames processed")
