...
class FileProcessor:
    ...
    def validate_files(self) -> None:
        ...
        elif self.xlsx_path.suffix.lower() != '.xls':
            raise ValueError(f"Expected .xls file, got: {self.xlsx_path}")
...
def main():
    try:
        processor = FileProcessor("430181.txt", "RRD017-2024_Comlist - FAIR.xls")
