...
const char* ssid = "CTX86";
const char* password = "#NWO1776i2025";
...
void applyPinConfig() {
  for (int i = 0; i < numRelays; i++) {
    ...
    digitalWrite(relayPinConfig[i], LOW);
  }
}
...
void setRelay(int idx, bool state) {
  ...
  // For the tester, we use active HIGH for LEDs
  digitalWrite(relayPinConfig[idx], state ? HIGH : LOW);
